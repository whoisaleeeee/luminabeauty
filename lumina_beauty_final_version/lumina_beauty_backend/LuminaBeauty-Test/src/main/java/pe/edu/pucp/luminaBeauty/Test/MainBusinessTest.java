...
//
//        clienteBL.sumarPuntos(cliente.getId_usuario(), 300);
//
...
//
//        productoBL.validarStock(producto.getId_producto(), 2);
//        System.out.println("ProductoBL.validarStock OK");
//
//        Producto productoEncontrado = productoBL.buscarProducto(producto.getId_producto());
//        System.out.println("ProductoBL.buscarProducto OK: " + productoEncontrado.getNombre());
//
//        productoBL.descontarStock(producto.getId_producto(), 1);
...
//
//        System.out.println("PagoBL.registrarPago OK: " + pagoRegistrado.getId_pago());
//    }
//
